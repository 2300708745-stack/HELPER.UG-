...
function MyTasksScreen({ name, session, verifyStatus, onVerifyUpdated, tasks, loading, error, onRetry, onComplete, onRate, busyId }) {
    ...
    <div className="min-h-screen flex justify-center" style={{ background: "#EDEAE0" }}>
      <div className="w-full max-w-md min-h-screen flex flex-col" style={{ background: "#F7F4EC" }}>
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {tab === "mine" && <MyTasksScreen name={name} session={session} verifyStatus={verifyStatus} onVerifyUpdated={loadSessionAndProfile} tasks={tasks} loading={loading} error={error} onRetry={loadTasks} onComplete={handleComplete} onRate={handleRate} busyId={busyId} />}
        </div>
